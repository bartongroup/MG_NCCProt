...
@fig-dl-e1-ip shows results for experiment 1 IP and a selection of contrasts. There are no differentially abundant proteins for DRB vs DMSO and TPL vs DMSO at nascent time point and at 2 h. The only differnce can be seen between time points.
